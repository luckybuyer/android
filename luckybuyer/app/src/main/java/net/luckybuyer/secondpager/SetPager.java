...
public class SetPager extends BasePager{
    ...
    private RelativeLayout rl_set_login;
    ...
    private void findView() {
        ...
        rl_set_login = (RelativeLayout) inflate.findViewById(R.id.rl_set_login);
        ...
        rl_set_login.setOnClickListener(new MyOnClickListener());
    }
        ...
        public void onClick(View view) {
            switch (view.getId()){
                ...
                case R.id.rl_set_us:
                    ...
                    break;
                case R.id.rl_set_login:
                    Utils.MyToast(context,"登陆");
                    break;
            }
        }
    }
