        ...
        public void onClick(View view) {
            switch (view.getId()) {
                ...
                case R.id.tv_shipping_edit:
                    ...
                    ((SecondPagerActivity) context).address = list.get(position);
                    ((SecondPagerActivity) context).address_id = list.get(position).getId();
                    Log.e("TAG_addressid", ((SecondPagerActivity) context).address_id + "" + ((SecondPagerActivity) context).address.getAddress());
                    break;
