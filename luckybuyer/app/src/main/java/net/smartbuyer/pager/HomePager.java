...
import net.smartbuyer.adapter.HomeImagePageAdapter;
import net.smartbuyer.adapter.HomeProductAdapter;
import net.smartbuyer.app.MyApplication;
import net.smartbuyer.base.BaseNoTrackPager;
import net.smartbuyer.bean.BannersBean;
import net.smartbuyer.bean.BroadcastBean;
import net.smartbuyer.bean.GameProductBean;
